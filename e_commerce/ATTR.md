...
* `特殊属性`：不同商品各自所独有的属性，如鞋子的使用人群、鞋面材质，手表的机芯等
...
* `在后端品类`上先创建一套`基础属性模`，模板中规定了当前品类的所有的属性，同时设置好的各种操作功能，如属性组、属性名、是否必填、是否参与搜索、维护方式、可选属性值等
...
* http://www.woshipm.com/u/705970/page/2
